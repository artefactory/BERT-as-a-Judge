...
def arc_easy_test():
	...
	return load_dataset("allenai/ai2_arc", name="ARC-Easy", split="test", process_fn=process_fn).select_columns(["question", "reference"])


def arc_easy_test_soft():
	dataset = arc_easy_test()
	return dataset.map(
