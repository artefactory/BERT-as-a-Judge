...
def arc_challenge_train():
	...
	return load_dataset("allenai/ai2_arc", name="ARC-Challenge", split="train", process_fn=process_fn).select_columns(["question", "reference"])


def arc_challenge_train_soft():
...
def arc_challenge_train_strict():
	dataset = arc_challenge_train()
	return dataset.map(
