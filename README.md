...
```bash
pip install torch transformers==4.57.0 datasets tqdm
```
...
* For using `RegexJudge` with the ROUGE and Math-Verify metrics:
...
## Advanced: Training BERTJudge on Your Data
